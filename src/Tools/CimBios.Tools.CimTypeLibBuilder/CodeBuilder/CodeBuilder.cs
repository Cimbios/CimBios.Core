...
internal class CodeBuilder(
    ...
    CodeBlockSyntax[] blockSyntaxes,
    string namespaceName)
{
    private static readonly string NamespaceBlock = "namespace";
    private static readonly string AnnotationBlock = "annotation";
    private static readonly string ClassBlock = "class";
    private static readonly string AttributeBlock = "attribute";
    private static readonly string Property1Block = "property1";
    private static readonly string PropertyMBlock = "propertyM";
    private static readonly string EnumBlock = "enum";
    private static readonly string EnumValueBlock = "enum_value";
    ...
    private string CompileEnumValues(ICimMetaClass metaEnum)
    {
        ...
        var enumValueList = _cimSchema.GetClassIndividuals(metaEnum);
