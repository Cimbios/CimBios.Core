...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : DCBaseTerminal(uuid, metaClass, isAuto)
{
}
/// <summary>
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromOperationalLimitSet(OperationalLimitSet
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Conductor(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromACLineSegmentPhases(ACLineSegmentPhase
  ...
  public void RemoveFromACLineSeriesSections(ACLineSeriesSection
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#ACLineSegmentPhase")]
public partial class ACLineSegmentPhase
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : PowerSystemResource(uuid, metaClass, isAuto)
{
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#ACLineSeriesSection")]
public partial class ACLineSeriesSection
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Equipment(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : OperationalLimit(uuid, metaClass, isAuto)
{
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToAssets(Asset assocObject) => AddAssoc1ToM(
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Document(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Measurement(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : MeasurementValue(uuid, metaClass, isAuto)
{
...
/// or group of assets.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#AnalyticScore")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToActivityRecords(ActivityRecord assocObject) => AddAssoc1ToM(
      nameof(ActivityRecords), assocObject);
  ...
  public void RemoveFromConfigurationEvents(ConfigurationEvent
  ...
  /// </summary>
  public AssetOrganisationRole[] AssetOrganisationRoles => GetAssoc1ToM<
      AssetOrganisationRole>(nameof(AssetOrganisationRoles));
  public void AddToAssetOrganisationRoles(AssetOrganisationRole
          assocObject) => AddAssoc1ToM(nameof(AssetOrganisationRoles),
      assocObject);
  public void RemoveFromAssetOrganisationRoles(AssetOrganisationRole
          assocObject) => RemoveAssoc1ToM(nameof(AssetOrganisationRoles),
      assocObject);
  public void RemoveAllFromAssetOrganisationRoles() => RemoveAllAssocs1ToM(
      nameof(AssetOrganisationRoles));
  /// <summary>
  ...
  public void RemoveFromPowerSystemResources(PowerSystemResource
    ...
    : Asset(uuid, metaClass, isAuto)
{
  ...
  public void AddToSeals(Seal assocObject) => AddAssoc1ToM(
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#AssetDeployment")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#AssetInfo")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#AssetOrganisationRole")]
public partial class AssetOrganisationRole
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : OrganisationRole(uuid, metaClass, isAuto)
{
...
/// Owner of the asset.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#AssetOwner")]
public partial class AssetOwner
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : AssetOrganisationRole(uuid, metaClass, isAuto)
{
}
/// <summary>
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : RotatingMachine(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : RotatingMachineInfo(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : SteamSupply(uuid, metaClass, isAuto)
{
}
/// <summary>
    ...
    : MeasurementValue(uuid, metaClass, isAuto)
{
  ...
  public void AddToReadingQualities(ReadingQuality assocObject) => AddAssoc1ToM(
      nameof(ReadingQualities), assocObject);
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromConductingEquipment(ConductingEquipment
  ...
  public void RemoveFromNetworkAssetDeployment(AssetDeployment
  ...
  public void AddToTransformerEnds(TransformerEnd assocObject) => AddAssoc1ToM(
      nameof(TransformerEnds), assocObject);
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : EquipmentContainer(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ProtectedSwitch(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#BreakerInfo")]
public partial class BreakerInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : OldSwitchInfo(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : AssetInfo(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : AuxiliaryEquipment(uuid, metaClass, isAuto)
{
}
/// <summary>
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Connector(uuid, metaClass, isAuto)
{
...
/// Busbar section data.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#BusbarSectionInfo")]
...
/// Cable data.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#CableInfo")]
public partial class CableInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : WireInfo(uuid, metaClass, isAuto)
{
    ...
    : PowerSystemResource(uuid, metaClass, isAuto)
{
  ...
  public void AddToThermalGeneratingUnits(ThermalGeneratingUnit
          assocObject) => AddAssoc1ToM(nameof(ThermalGeneratingUnits),
      assocObject);
  public void RemoveFromThermalGeneratingUnits(ThermalGeneratingUnit
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : EndDeviceFunction(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : PrimeMover(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#ConcentricNeutralCableInfo")]
public partial class ConcentricNeutralCableInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : CableInfo(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ConductingEquipment(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ActivityRecord(uuid, metaClass, isAuto)
{
    ...
    : PowerSystemResource(uuid, metaClass, isAuto)
{
  ...
  /// </summary>
  public ConnectivityNode[] ConnectivityNodes => GetAssoc1ToM<ConnectivityNode>(
  ...
  public void AddToConnectivityNodes(
      ...
      assocObject);
  public void
  RemoveFromConnectivityNodes(ConnectivityNode assocObject) => RemoveAssoc1ToM(
      nameof(ConnectivityNodes), assocObject);
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#ControlledShuntReactorInfo")]
public partial class ControlledShuntReactorInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ShuntReactorInfo(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#CurrentLimit")]
    ...
    : Sensor(uuid, metaClass, isAuto)
{
  ...
  public void AddToWindings(
      ...
      assocObject);
  public void RemoveFromWindings(CurrentTransformerWinding
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#CurrentTransformerWinding")]
public partial class CurrentTransformerWinding
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : SensorWinding(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#Curve")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#CurveData")]
    ...
    : OrganisationRole(uuid, metaClass, isAuto)
{
  ...
  public void AddToCustomerAgreements(
      CustomerAgreement assocObject) => AddAssoc1ToM(nameof(CustomerAgreements),
      assocObject);
  public void RemoveFromCustomerAgreements(CustomerAgreement
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Agreement(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromUsagePoints(UsagePoint assocObject) => RemoveAssoc1ToM(
      nameof(UsagePoints), assocObject);
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ACDCTerminal(uuid, metaClass, isAuto)
{
}
/// <summary>
    ...
    : Equipment(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromDCTerminals(DCTerminal assocObject) => RemoveAssoc1ToM(
      nameof(DCTerminals), assocObject);
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : DCEquipmentContainer(uuid, metaClass, isAuto)
{
}
/// <summary>
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : DCConductingEquipment(uuid, metaClass, isAuto)
{
...
/// dates.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#DeploymentDate")]
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : FossilSteamSupply(uuid, metaClass, isAuto)
{
}
/// <summary>
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#EarthFaultCompensator")]
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : AssetContainer(uuid, metaClass, isAuto)
{
  ...
  public void AddToEndDeviceFunctions(
      EndDeviceFunction assocObject) => AddAssoc1ToM(nameof(EndDeviceFunctions),
      assocObject);
  public void RemoveFromEndDeviceFunctions(EndDeviceFunction
    ...
    : ActivityRecord(uuid, metaClass, isAuto)
{
  ...
  public void
  AddToEndDeviceEventDetails(EndDeviceEventDetail assocObject) => AddAssoc1ToM(
      nameof(EndDeviceEventDetails), assocObject);
  public void RemoveFromEndDeviceEventDetails(EndDeviceEventDetail
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : AssetFunction(uuid, metaClass, isAuto)
{
...
/// operational limits.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#EnvironmentalDependentLimit")]
public partial class EnvironmentalDependentLimit
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : LimitDependency(uuid, metaClass, isAuto)
{
}
/// <summary>
    ...
    : PowerSystemResource(uuid, metaClass, isAuto)
{
  ...
  public void AddToAdditionalEquipmentContainer(EquipmentContainer
          assocObject) => AddAssoc1ToM(nameof(AdditionalEquipmentContainer),
      assocObject);
  public void RemoveFromAdditionalEquipmentContainer(EquipmentContainer
  ...
  public void AddToLimitDependencyModel(
      LimitDependency assocObject) => AddAssoc1ToM(nameof(LimitDependencyModel),
      assocObject);
  public void RemoveFromLimitDependencyModel(LimitDependency
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ConnectivityNodeContainer(uuid, metaClass, isAuto)
{
  ...
  public void AddToAdditionalGroupedEquipment(
      Equipment assocObject) => AddAssoc1ToM(nameof(AdditionalGroupedEquipment),
      assocObject);
  public void RemoveFromAdditionalGroupedEquipment(Equipment
          assocObject) => RemoveAssoc1ToM(nameof(AdditionalGroupedEquipment),
      assocObject);
  public void RemoveAllFromAdditionalGroupedEquipment() => RemoveAllAssocs1ToM(
      nameof(AdditionalGroupedEquipment));
  /// <summary>
  /// Contained equipment.
  /// </summary>
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#ErpItemMaster")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#Facility")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#FrequencyLimit")]
    ...
    : Equipment(uuid, metaClass, isAuto)
{
  ...
  public void AddToRotatingMachine(RotatingMachine assocObject) => AddAssoc1ToM(
      nameof(RotatingMachine), assocObject);
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  /// </summary>
  public SubGeographicalRegion[] Regions => GetAssoc1ToM<SubGeographicalRegion>(
      nameof(Regions));
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#GroundAction")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#GroundingImpedance")]
public partial class GroundingImpedance
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : EarthFaultCompensator(uuid, metaClass, isAuto)
{
    ...
    : FossilSteamSupply(uuid, metaClass, isAuto)
{
  ...
  public void AddToCombustionTurbines(
      CombustionTurbine assocObject) => AddAssoc1ToM(nameof(CombustionTurbines),
      assocObject);
  public void RemoveFromCombustionTurbines(CombustionTurbine
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : GeneratingUnit(uuid, metaClass, isAuto)
{
    ...
    : PowerSystemResource(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromHydroGeneratingUnits(HydroGeneratingUnit
    ...
    : ModelObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToNames(Name assocObject) => AddAssoc1ToM(
  ...
  public void AddToCustomAttributes(UserAttribute assocObject) => AddAssoc1ToM(
      nameof(CustomAttributes), assocObject);
  ...
  ///
  /// </summary>
  public OrganisationRole[] OrganisationRoles => GetAssoc1ToM<OrganisationRole>(
  ...
  public void AddToOrganisationRoles(
      ...
      assocObject);
  public void
  RemoveFromOrganisationRoles(OrganisationRole assocObject) => RemoveAssoc1ToM(
      nameof(OrganisationRoles), assocObject);
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#InUseDate")]
    ...
    : ModelObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToIntervalReadings(
      ...
      assocObject);
  public void RemoveFromIntervalReadings(
      IntervalReading assocObject) => RemoveAssoc1ToM(nameof(IntervalReadings),
      assocObject);
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : BaseReading(uuid, metaClass, isAuto)
{
}
/// <summary>
...
/// resistance.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#Junction")]
...
/// for this device and a compound type allows a query to return multiple dates.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#LifecycleDate")]
...
/// equipment..
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#LimitDependency")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromOperationalLimit(
      OperationalLimit assocObject) => RemoveAssoc1ToM(nameof(OperationalLimit),
      assocObject);
...
/// limit.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#LimitScalingLimit")]
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ShuntCompensator(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#Manufacturer")]
    ...
    : OrganisationRole(uuid, metaClass, isAuto)
{
  ...
  public void AddToProductAssetModels(
      ProductAssetModel assocObject) => AddAssoc1ToM(nameof(ProductAssetModels),
      assocObject);
  public void RemoveFromProductAssetModels(ProductAssetModel
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : EndDevice(uuid, metaClass, isAuto)
{
  ...
  public void AddToMeterMultipliers(
      ...
      assocObject);
  public void RemoveFromMeterMultipliers(
      MeterMultiplier assocObject) => RemoveAssoc1ToM(nameof(MeterMultipliers),
      assocObject);
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToEndDeviceEvents(EndDeviceEvent assocObject) => AddAssoc1ToM(
      nameof(EndDeviceEvents), assocObject);
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#MutualCoupling")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#NoLoadTest")]
public partial class NoLoadTest
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : TransformerTest(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#OldSwitchInfo")]
public partial class OldSwitchInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : SwitchInfo(uuid, metaClass, isAuto)
{
}
/// <summary>
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#OperationalLimit")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToLimitScalingLimit(
      LimitScalingLimit assocObject) => AddAssoc1ToM(nameof(LimitScalingLimit),
      assocObject);
  public void
  RemoveFromLimitScalingLimit(LimitScalingLimit assocObject) => RemoveAssoc1ToM(
...
/// together as a set.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#OperationalLimitSet")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromOperationalLimitValue(OperationalLimit
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#OperationalLimitType")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromRoles(OrganisationRole assocObject) => RemoveAssoc1ToM(
      nameof(Roles), assocObject);
  ...
  public void AddToChildOrganisations(Organisation assocObject) => AddAssoc1ToM(
      nameof(ChildOrganisations), assocObject);
...
/// Overhead wire data.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#OverheadWireInfo")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PerLengthImpedance")]
public partial class PerLengthImpedance
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : PerLengthLineParameter(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromACLineSeriesSection(ACLineSeriesSection
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PerLengthLineParameter")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PerLengthPhaseImpedance")]
public partial class PerLengthPhaseImpedance
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : PerLengthImpedance(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PerLengthSequenceImpedance")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PetersenCoil")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PhaseImpedanceData")]
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : TapChanger(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : PhaseTapChangerNonLinear(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : PhaseTapChanger(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PhaseTapChangerTable")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToPhaseTapChangerTabular(PhaseTapChangerTabular
          assocObject) => AddAssoc1ToM(nameof(PhaseTapChangerTabular),
      assocObject);
  public void RemoveFromPhaseTapChangerTabular(PhaseTapChangerTabular
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#PhaseTapChangerTablePoint")]
public partial class PhaseTapChangerTablePoint
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : TapChangerTablePoint(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : PowerElectronicsUnit(uuid, metaClass, isAuto)
{
}
/// <summary>
    ...
    : EquipmentContainer(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromSubstations(Substation assocObject) => RemoveAssoc1ToM(
      nameof(Substations), assocObject);
    ...
    : Sensor(uuid, metaClass, isAuto)
{
  ...
  public void AddToWindings(
      PotentialTransformerWinding assocObject) => AddAssoc1ToM(nameof(Windings),
      assocObject);
  public void RemoveFromWindings(PotentialTransformerWinding
          assocObject) => RemoveAssoc1ToM(nameof(Windings), assocObject);
  public void RemoveAllFromWindings() => RemoveAllAssocs1ToM(nameof(Windings));
}
/// <summary>
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#PotentialTransformerWinding")]
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : RegulatingCondEq(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromPowerElectronicsUnit(PowerElectronicsUnit
...
/// </summary>
[CimClass(
    "http://gost.ru/2019/schema-cim01#PowerElectronicsReactiveCapabilityCurve")]
    ...
    : ConductingEquipment(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromPowerTransformerEnd(PowerTransformerEnd
  ...
  public void AddToTransformerTanks(
      ...
      assocObject);
  public void RemoveFromTransformerTanks(
      TransformerTank assocObject) => RemoveAssoc1ToM(nameof(TransformerTanks),
      assocObject);
  ...
  public void RemoveFromStabilizingWindings(StabilizingWinding
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : TransformerEnd(uuid, metaClass, isAuto)
{
    ...
    : PowerSystemResource(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromSynchronousMachines(SynchronousMachine
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToAsset(Asset assocObject) => AddAssoc1ToM(
...
/// the tap step.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#RatioTapChangerTable")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToRatioTapChanger(RatioTapChanger assocObject) => AddAssoc1ToM(
      nameof(RatioTapChanger), assocObject);
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#RatioTapChangerTablePoint")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#RegulatingControl")]
    ...
    : PowerSystemResource(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromRegulatingCondEq(
      RegulatingCondEq assocObject) => RemoveAssoc1ToM(nameof(RegulatingCondEq),
      assocObject);
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : DynamicsFunctionBlock(uuid, metaClass, isAuto)
{
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#SensorWinding")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#SeriesCapacitorInfo")]
public partial class SeriesCapacitorInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : SeriesCompensatorInfo(uuid, metaClass, isAuto)
{
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#SeriesCompensatorInfo")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#SeriesVarCapacitorInfo")]
public partial class SeriesVarCapacitorInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : SeriesCapacitorInfo(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Location(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#ShortCircuitTest")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#ShuntCapacitorInfo")]
public partial class ShuntCapacitorInfo
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : ShuntCompensatorInfo(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#ShuntCompensatorInfo")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#ShuntReactorInfo")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#StabilizingWinding")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#StaticVarCompensatorInfo")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#StreetDetail")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#Structure")]
    ...
    : AssetContainer(uuid, metaClass, isAuto)
{
  ...
  public void AddToWireSpacingInfos(
      ...
      assocObject);
  public void RemoveFromWireSpacingInfos(
      WireSpacingInfo assocObject) => RemoveAssoc1ToM(nameof(WireSpacingInfos),
      assocObject);
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToLines(Line assocObject) => AddAssoc1ToM(
  ...
  public void AddToPlants(Plant assocObject) => AddAssoc1ToM(
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#SwitchInfo")]
    ...
    : RotatingMachine(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromPrimeMovers(PrimeMover assocObject) => RemoveAssoc1ToM(
      nameof(PrimeMovers), assocObject);
  ...
  public void AddToReactiveCapabilityCurves(ReactiveCapabilityCurve
          assocObject) => AddAssoc1ToM(nameof(ReactiveCapabilityCurves),
      assocObject);
  public void RemoveFromReactiveCapabilityCurves(ReactiveCapabilityCurve
  ...
  public void AddToExcitationSystem(
      ...
      assocObject);
  public void RemoveFromExcitationSystem(
      ExcitationSystem assocObject) => RemoveAssoc1ToM(nameof(ExcitationSystem),
      assocObject);
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : SynchronousMachineDynamics(uuid, metaClass, isAuto)
{
}
/// <summary>
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : RotatingMachineDynamics(uuid, metaClass, isAuto)
{
...
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : SynchronousMachineDetailed(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TapChangerControl")]
public partial class TapChangerControl
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : RegulatingControl(uuid, metaClass, isAuto)
{
}
/// <summary>
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#TapChangerDependentLimitPoint")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#TapChangerDependentLimitTable")]
    ...
    : LimitDependency(uuid, metaClass, isAuto)
{
  ...
  public void AddToTapChangerDependentLimitPoints(TapChangerDependentLimitPoint
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TapChangerTablePoint")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TapeShieldCableInfo")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TemperatureDependentLimitPoint")]
...
/// temperature input.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TemperatureDependentLimitTable")]
public partial class TemperatureDependentLimitTable
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : EnvironmentalDependentLimit(uuid, metaClass, isAuto)
{
  ...
  [] TemperatureLimitTablePoint => GetAssoc1ToM<TemperatureDependentLimitPoint>(
      nameof(TemperatureLimitTablePoint));
  public void AddToTemperatureLimitTablePoint(TemperatureDependentLimitPoint
  ...
  public void RemoveFromTemperatureLimitTablePoint(
      ...
      assocObject);
  public void RemoveAllFromTemperatureLimitTablePoint() => RemoveAllAssocs1ToM(
      nameof(TemperatureLimitTablePoint));
}
/// <summary>
    ...
    : ACDCTerminal(uuid, metaClass, isAuto)
{
  ...
  public void AddToAuxiliaryEquipment(AuxiliaryEquipment
          assocObject) => AddAssoc1ToM(nameof(AuxiliaryEquipment), assocObject);
  public void RemoveFromAuxiliaryEquipment(AuxiliaryEquipment
  ...
  public void RemoveFromHasFirstMutualCoupling(MutualCoupling
  ...
  public void RemoveFromHasSecondMutualCoupling(MutualCoupling
  ...
  public void AddToRegulatingControl(
      RegulatingControl assocObject) => AddAssoc1ToM(nameof(RegulatingControl),
      assocObject);
  public void
  RemoveFromRegulatingControl(RegulatingControl assocObject) => RemoveAssoc1ToM(
    ...
    : GeneratingUnit(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromFossilFuels(FossilFuel assocObject) => RemoveAssoc1ToM(
      nameof(FossilFuels), assocObject);
  ...
  public void
  AddToCapacityConfiguration(CapacityConfiguration assocObject) => AddAssoc1ToM(
      nameof(CapacityConfiguration), assocObject);
  public void RemoveFromCapacityConfiguration(CapacityConfiguration
    ...
    : Curve(uuid, metaClass, isAuto)
{
  ...
  public void RemoveFromAsynchronousMachine(AsynchronousMachine
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#Tower")]
public partial class Tower
(string uuid, ICimMetaClass metaClass, bool isAuto = false)
    : Structure(uuid, metaClass, isAuto)
{
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TransformerCoreAdmittance")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void AddToFromMeshImpedance(TransformerMeshImpedance
          assocObject) => AddAssoc1ToM(nameof(FromMeshImpedance), assocObject);
  public void RemoveFromFromMeshImpedance(TransformerMeshImpedance
  ...
  public void AddToToMeshImpedance(TransformerMeshImpedance
          assocObject) => AddAssoc1ToM(nameof(ToMeshImpedance), assocObject);
  public void RemoveFromToMeshImpedance(TransformerMeshImpedance
          assocObject) => RemoveAssoc1ToM(nameof(ToMeshImpedance), assocObject);
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TransformerEndInfo")]
    ...
    : AssetInfo(uuid, metaClass, isAuto)
{
  ...
  public void AddToEnergisedEndNoLoadTests(
      ...
      assocObject);
  public void
  RemoveFromEnergisedEndNoLoadTests(NoLoadTest assocObject) => RemoveAssoc1ToM(
      nameof(EnergisedEndNoLoadTests), assocObject);
  ...
  public void AddToEnergisedEndShortCircuitTests(ShortCircuitTest
          assocObject) => AddAssoc1ToM(nameof(EnergisedEndShortCircuitTests),
      assocObject);
  public void RemoveFromEnergisedEndShortCircuitTests(ShortCircuitTest
  ...
  public void AddToGroundedEndShortCircuitTests(ShortCircuitTest
          assocObject) => AddAssoc1ToM(nameof(GroundedEndShortCircuitTests),
      assocObject);
  public void RemoveFromGroundedEndShortCircuitTests(ShortCircuitTest
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TransformerMeshImpedance")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TransformerStarImpedance")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TransformerTank")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TransformerTankInfo")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#TransformerTest")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#UndergroundStructure")]
    ...
    : IdentifiedObject(uuid, metaClass, isAuto)
{
  ...
  public void
  AddToMetrologyRequirements(MetrologyRequirement assocObject) => AddAssoc1ToM(
      nameof(MetrologyRequirements), assocObject);
  public void RemoveFromMetrologyRequirements(MetrologyRequirement
  ...
  /// </summary>
  public PricingStructure[] PricingStructures => GetAssoc1ToM<PricingStructure>(
  ...
  public void AddToPricingStructures(
      ...
      assocObject);
  public void
  RemoveFromPricingStructures(PricingStructure assocObject) => RemoveAssoc1ToM(
      nameof(PricingStructures), assocObject);
  ...
  public void AddToServiceMultipliers(
      ServiceMultiplier assocObject) => AddAssoc1ToM(nameof(ServiceMultipliers),
      assocObject);
  public void RemoveFromServiceMultipliers(ServiceMultiplier
    ...
    : EquipmentContainer(uuid, metaClass, isAuto)
{
  ...
  public void AddToBays(Bay assocObject) => AddAssoc1ToM(
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#VoltageLimit")]
...
///
/// </summary>
[CimClass("http://gost.ru/2019/schema-cim01#VoltageLimitDurationCurve")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#WireAssemblyInfo")]
    ...
    : AssetInfo(uuid, metaClass, isAuto)
{
  ...
  public void AddToPerLengthLineParameter(PerLengthLineParameter
          assocObject) => AddAssoc1ToM(nameof(PerLengthLineParameter),
      assocObject);
  public void RemoveFromPerLengthLineParameter(PerLengthLineParameter
...
/// characteristics.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#WireInfo")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#WirePhaseInfo")]
...
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#WirePosition")]
...
/// not neutral.
/// </summary>
[CimClass("http://iec.ch/TC57/CIM100#WireSpacingInfo")]
